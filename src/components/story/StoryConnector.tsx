 ...
 */
export function StoryConnector({ active = false, orientation = 'vertical', label }: StoryConnectorProps) {
  ...
  return (
    <div className="flex flex-col items-center py-1" aria-hidden="true">
      <div
        ...
        style={{ background: active ? 'var(--accent)' : 'var(--border-strong)', opacity: active ? 0.9 : 0.5 }}
      />
      <svg width="8" height="8" viewBox="0 0 8 8" aria-hidden="true" style={{ display: 'block', marginTop: 2, color: active ? 'var(--accent)' : 'var(--border-strong)', opacity: active ? 0.9 : 0.5 } as React.CSSProperties}>
